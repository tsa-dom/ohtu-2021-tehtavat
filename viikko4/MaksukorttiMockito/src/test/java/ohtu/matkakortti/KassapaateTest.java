...
public class KassapaateTest {
    ...
    @Test
    public void kortilleLisataanRahaaJosLisattavaSummaOnPositiivinen() {
        when(kortti.getSaldo()).thenReturn(5);
        kassa.lataa(kortti, 7);
        
        verify(kortti).lataa(eq(7));
    }
    
    @Test
    public void kortilleEiLisataRahaaJosLisattavaSummaOnNegatiivinen() {
        when(kortti.getSaldo()).thenReturn(5);
