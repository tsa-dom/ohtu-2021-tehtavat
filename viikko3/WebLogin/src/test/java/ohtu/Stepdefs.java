...
public class Stepdefs {
    ...
    public void validUsernameAndPasswordAndPasswordConfirmationGiven(String username, String password) {
    ...
    public void tooShortUsernameAndValidPasswordGiven(String username, String password) {
        signUpWith(username, password, password);
    }
    ...
    @When("correct username {string} and valid password {string} and not matching password confirmation {string} are entered")
    public void correctUsernameAndNotMatchingPasswordsAreEntered(String username, String password, String passwordConfirmation) {
        signUpWith(username, password, passwordConfirmation);
    }
    
    @Given("user with username {string} with password {string} is successfully created")
    public void usernameWithPasswordIsSuccesfullyCreated(String username, String password) {
        commandNewUserIsSelected();
        signUpWith(username, password, password);
    }
    
    @Given("user with username {string} and password {string} is tried to be created")
    public void usernameWithPasswordIsTriedToBeCreated(String username, String password) {
        commandNewUserIsSelected();
        signUpWith(username, password, password);
    }
    
    @When("nonsuccessfully created username {string} and password {string} are given")
    public void unsuccesfullyCreatedUsernameAndPasswordAreGiven(String username, String password) {
        logInWith(username, password);
    }
